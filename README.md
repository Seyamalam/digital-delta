...
- MapLibre Native renders a checksum-pinned Android geographic extract generated from the projector's reviewed OpenStreetMap-derived PMTiles archive; Compose overlays remain only for controls and a renderer-failure route diagram
