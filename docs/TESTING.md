...
| M8 | Reachability, reserve, delay/replan, event, and custody tests | Bilingual boat-to-simulated-drone handoff plus compiled delayed-boat journey | No feasible rendezvous; delayed-boat UI execution pending |
