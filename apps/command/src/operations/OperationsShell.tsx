  ...
  return <SidebarProvider className="hq-shell" data-language={language} style={{ "--sidebar-width": "17rem" } as CSSProperties}>
    ...
    <SidebarInset className="min-w-0">
      ...
      <div className="hq-source-bar" data-source={exercise ? "exercise" : connected ? "live" : "stale"}>
        <span><span className="hq-source-dot" /><strong>{exercise ? say("EXERCISE DATA", "মহড়ার তথ্য") : projection.includesSimulated ? say("SIMULATED OBSERVATIONS INCLUDED", "সিমুলেটেড পর্যবেক্ষণ অন্তর্ভুক্ত") : connected ? say("FIELD OBSERVATIONS", "ফিল্ড পর্যবেক্ষণ") : say("LAST RECEIVED STATE", "সর্বশেষ প্রাপ্ত অবস্থা")}</strong><span>{exercise ? say("Seeded scenario. Not a live emergency.", "নির্ধারিত দৃশ্য। বাস্তব জরুরি অবস্থা নয়।") : say(`Sequence ${projection.latestSequence} · Read-only headquarters`, `ক্রম ${projection.latestSequence} · শুধু পর্যবেক্ষণ`)}</span></span>
